...
ax1.set_xlabel (r'$\phi$ (deg)', fontsize=FontSize)
ax1.set_ylabel (r'energy gain (MeV)', fontsize=FontSize)
ax1.text (65,12,r'{(a)}', fontsize=28)
...
ax2.set_xlabel (r'$\phi$ (deg)', fontsize=FontSize)
ax2.set_ylabel (r'dipole kick (keV/c)', fontsize=FontSize)
ax2.text (65,0.2,r'{(b)}', fontsize=28)
...
ax3.set_xlabel (r'$\phi$ (deg)', fontsize=FontSize)
ax3.set_ylabel (r'focusing (keV/(c$\cdot$m))', fontsize=FontSize)
ax3.legend(fontsize=14,loc=2)
ax3.text (65,0.08,r'{(c)}', fontsize=28)
...
ax4.set_xlabel (r'$\phi$ (deg)', fontsize=FontSize)
ax4.set_ylabel (r'relative focusing (\%)', fontsize=FontSize)
ax4.text (65,0.27,r'{(d)}', fontsize=28)
